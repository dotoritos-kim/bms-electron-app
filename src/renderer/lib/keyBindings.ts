...
export const DEFAULT_BINDINGS: KeyBinding[] = [
  ...
  { label: '선택 도구 (숫자)', action: 'toolSelect', key: '1' },
  { label: '노트 추가', action: 'toolAddNote', key: 'a' },
  { label: '노트 추가 (숫자)', action: 'toolAddNote', key: '2' },
  { label: '삭제 도구', action: 'toolDelete', key: 'd' },
  { label: '삭제 도구 (숫자)', action: 'toolDelete', key: '3' },
  { label: '이동 도구', action: 'toolMove', key: 'm' },
  { label: '이동 도구 (숫자)', action: 'toolMove', key: '4' },
  { label: '키음 도구', action: 'toolKeysound', key: 'k' },
  { label: '키음 도구 (숫자)', action: 'toolKeysound', key: '5' },
  { label: 'BPM 도구', action: 'toolBpm', key: 'b' },
  { label: 'BPM 도구 (숫자)', action: 'toolBpm', key: '6' },
  { label: 'STOP 도구', action: 'toolStop', key: 't' },
  { label: 'STOP 도구 (숫자)', action: 'toolStop', key: '7' },
