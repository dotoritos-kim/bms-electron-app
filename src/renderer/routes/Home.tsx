...
import { FolderOpen, File, Play, Edit, Music, RefreshCw } from 'lucide-react';
...
export function Home({ currentFile, onOpenFile, onPlay, onEdit }: HomeProps) {
  ...
  // Load chart when file is selected
  useEffect(() => {
    if (currentFile) {
        ...
        {!currentFile && (
          <div className="h-full flex items-center justify-center text-zinc-500">
            <div className="text-center">
              ...
              <p className="text-sm mt-1">or press Ctrl+O to open a file</p>
            </div>
          </div>
        )}
